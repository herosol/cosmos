...
<section id="logOn">
    <div class="logBlk">
        <div class="inside">
            <form action="" method="post" autocomplete="off" class="frmAjax" id="frmPSignup">
                ...
                <div class="oRLine"><span>OR</span></div>
                 -->
                <div class="txtGrp">
                    <input type="text" id="nickname" name="nickname" class="txtBox" placeholder="Nickname" autofocus required="">
                </div>
                <div class="txtGrp">
                    <input type="text" id="fname" name="fname" class="txtBox" placeholder="First Name">
                </div>
                <div class="txtGrp">
