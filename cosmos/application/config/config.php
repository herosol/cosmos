...
if ($_SERVER['HTTP_HOST'] != 'localhost') {
	$config['base_url'] = 'https://herosolutions.com.pk/sarim/cosmos';
} else {
	$config['base_url'] = 'http://localhost/work/cosmos/cosmos';
}
/*
|--------------------------------------------------------------------------
| Index File
...
$config['sess_cookie_name'] = 'pfsc_session';
...
$config['csrf_token_name'] = 'csrf_pfsc_name';
